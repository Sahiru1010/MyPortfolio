...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Io(e,t,n){let r=new Float32Array(So),i=new W(0,1,0);return new ga({name:`SphericalGaussianBlur`,defines:{n:So,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:zo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Lo(){return new ga({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:zo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ro(){return new ga({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:zo(),fragmentShader:`
	...
	`}var Bo=class extends kn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new na(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`;class re{constructor(e){this.props=e||{},this.uniforms=this.props.material?.uniforms,this.scene=null,this.camera=null,this.material=null,this.geometry=null,this.plane=null}init(){this.scene=new hr,this.camera=new za,this.uniforms&&(this.material=new _a(this.props.material),this.geometry=new sa(2,2),this.plane=new ji(this.geometry,this.material),this.scene.add(this.plane))}update(){O.renderer.setRenderTarget(this.props.output||null),O.renderer.render(this.scene,this.camera),O.renderer.setRenderTarget(null)}}class ie extends re{constructor(e){super({material:{vertexShader:ne,fragmentShader:A,uniforms:{boundarySpace:{value:e.cellScale},px:{value:e.cellScale},fboSize:{value:e.fboSize},velocity:{value:e.src.texture},dt:{value:e.dt},isBFECC:{value:!0}}},output:e.dst}),this.uniforms=this.props.material.uniforms,this.init()}init(){super.init(),this.createBoundary()}createBoundary(){let e=new li,t=new Float32Array([-1,-1,0,-1,1,0,-1,1,0,1,1,0,1,1,0,1,-1,0,1,-1,0,-1,-1,0]);e.setAttribute(`position`,new Jr(t,3));let n=new _a({vertexShader:`
  attribute vec3 position;
  uniform vec2 px;
  precision highp float;
  varying vec2 uv;
...
`,fragmentShader:A,uniforms:this.uniforms});this.line=new ta(e,n),this.scene.add(this.line)}update({dt:e,isBounce:t,BFECC:n}){this.uniforms.dt.value=e,this.line.visible=t,this.uniforms.isBFECC.value=n,super.update()}}class j extends re{constructor(e){super({output:e.dst}),this.init(e)}init(e){super.init();let t=new sa(1,1),n=new _a({vertexShader:`
    precision highp float;
    attribute vec3 position;
    attribute vec2 uv;
    uniform vec2 center;
...
`,blending:2,depthWrite:!1,uniforms:{px:{value:e.cellScale},force:{value:new U(0,0)},center:{value:new U(0,0)},scale:{value:new U(e.cursor_size,e.cursor_size)}}});this.mouse=new ji(t,n),this.scene.add(this.mouse)}update(e){let t=k.diff.x/2*e.mouse_force,n=k.diff.y/2*e.mouse_force,r=e.cursor_size*e.cellScale.x,i=e.cursor_size*e.cellScale.y,a=Math.min(Math.max(k.coords.x,-1+r+e.cellScale.x*2),1-r-e.cellScale.x*2),o=Math.min(Math.max(k.coords.y,-1+i+e.cellScale.y*2),1-i-e.cellScale.y*2),s=this.mouse.material.uniforms;s.force.value.set(t,n),s.center.value.set(a,o),s.scale.value.set(e.cursor_size,e.cursor_size),super.update()}}class M extends re{constructor(e){super({material:{vertexShader:ne,fragmentShader:`
    precision highp float;
    uniform sampler2D velocity;
...
`,uniforms:{boundarySpace:{value:e.boundarySpace},velocity:{value:e.src.texture},px:{value:e.cellScale},dt:{value:e.dt}}},output:e.dst}),this.init()}update({vel:e}){this.uniforms.velocity.value=e.texture,super.update()}}class oe extends re{constructor(e){super({material:{vertexShader:ne,fragmentShader:`
    precision highp float;
...
`,uniforms:{boundarySpace:{value:e.boundarySpace},pressure:{value:e.src_p.texture},velocity:{value:e.src_v.texture},px:{value:e.cellScale},dt:{value:e.dt}}},output:e.dst}),this.init()}update({vel:e,pressure:t}){this.uniforms.velocity.value=e.texture,this.uniforms.pressure.value=t.texture,super.update()}}class ce{constructor(e){this.options={iterations_poisson:32,iterations_viscous:32,mouse_force:20,resolution:.5,cursor_size:100,viscous:30,isBounce:!1,dt:.014,isViscous:!1,BFECC:!0,...e},this.fbos={vel_0:null,vel_1:null,vel_viscous0:null,vel_viscous1:null,div:null,pressure_0:null,pressure_1:null},this.fboSize=new U,this.cellScale=new U,this.boundarySpace=new U,this.init()}init(){this.calcSize(),this.createAllFBO(),this.createShaderPass()}getFloatType(){return/(iPad|iPhone|iPod)/i.test(navigator.userAgent)?je:Ae}createAllFBO(){let e={type:this.getFloatType(),depthBuffer:!1,stencilBuffer:!1,minFilter:I,magFilter:I,wrapS:xe,wrapT:xe};for(let t in this.fbos)this.fbos[t]=new kn(this.fboSize.x,this.fboSize.y,e)}createShaderPass(){this.advection=new ie({cellScale:this.cellScale,fboSize:this.fboSize,dt:this.options.dt,src:this.fbos.vel_0,dst:this.fbos.vel_1}),this.externalForce=new j({cellScale:this.cellScale,cursor_size:this.options.cursor_size,dst:this.fbos.vel_1}),this.viscous=new M({cellScale:this.cellScale,boundarySpace:this.boundarySpace,viscous:this.options.viscous,src:this.fbos.vel_1,dst:this.fbos.vel_viscous1,dst_:this.fbos.vel_viscous0,dt:this.options.dt}),this.divergence=new ae({cellScale:this.cellScale,boundarySpace:this.boundarySpace,src:this.fbos.vel_viscous0,dst:this.fbos.div,dt:this.options.dt}),this.poisson=new oe({cellScale:this.cellScale,boundarySpace:this.boundarySpace,src:this.fbos.div,dst:this.fbos.pressure_1,dst_:this.fbos.pressure_0}),this.pressure=new se({cellScale:this.cellScale,boundarySpace:this.boundarySpace,src_p:this.fbos.pressure_0,src_v:this.fbos.vel_viscous0,dst:this.fbos.vel_0,dt:this.options.dt})}calcSize(){let e=Math.max(1,Math.round(this.options.resolution*O.width)),t=Math.max(1,Math.round(this.options.resolution*O.height)),n=1/e,r=1/t;this.cellScale.set(n,r),this.fboSize.set(e,t)}resize(){this.calcSize();for(let e in this.fbos)this.fbos[e].setSize(this.fboSize.x,this.fboSize.y)}update(){this.options.isBounce?this.boundarySpace.set(0,0):this.boundarySpace.copy(this.cellScale),this.advection.update({dt:this.options.dt,isBounce:this.options.isBounce,BFECC:this.options.BFECC}),this.externalForce.update({cursor_size:this.options.cursor_size,mouse_force:this.options.mouse_force,cellScale:this.cellScale});let e=this.fbos.vel_1;this.options.isViscous&&(e=this.viscous.update({viscous:this.options.viscous,iterations:this.options.iterations_viscous,dt:this.options.dt})),this.divergence.update({vel:e});let t=this.poisson.update({iterations:this.options.iterations_poisson});this.pressure.update({vel:e,pressure:t})}}class N{constructor(){this.init()}init(){this.simulation=new ce,this.scene=new hr,this.camera=new za,this.output=new ji(new sa(2,2),new _a({vertexShader:ne,fragmentShader:`
    precision highp float;
    uniform sampler2D velocity;
...
`,transparent:!0,depthWrite:!1,uniforms:{velocity:{value:this.simulation.fbos.vel_0.texture},boundarySpace:{value:new U},palette:{value:f},bgColor:{value:_}}})),this.scene.add(this.output)}addScene(e){this.scene.add(e)}resize(){this.simulation.resize()}render(){O.renderer.setRenderTarget(null),O.renderer.render(this.scene,this.camera)}update(){this.simulation.update(),this.render()}}class P{constructor(e){this.props=e,O.init(e.$wrapper),k.init(e.$wrapper),k.autoIntensity=e.autoIntensity,k.takeoverDuration=e.takeoverDuration,this.lastUserInteraction=performance.now(),k.onInteract=()=>{this.lastUserInteraction=performance.now(),this.autoDriver&&this.autoDriver.forceStop()},this.autoDriver=new te(k,this,{enabled:e.autoDemo,speed:e.autoSpeed,resumeDelay:e.autoResumeDelay,rampDuration:e.autoRampDuration}),this.init(),this._loop=this.loop.bind(this),this._resize=this.resize.bind(this),window.addEventListener(`resize`,this._resize),this._onVisibility=()=>{document.hidden?this.pause():T.current&&this.start()},document.addEventListener(`visibilitychange`,this._onVisibility),this.running=!1}init(){this.props.$wrapper.prepend(O.renderer.domElement),this.output=new N}resize(){O.resize(),this.output.resize()}render(){this.autoDriver&&this.autoDriver.update(),k.update(),O.update(),this.output.update()}loop(){this.running&&(this.render(),C.current=requestAnimationFrame(this._loop))}start(){this.running||(this.running=!0,this._loop())}pause(){this.running=!1,C.current&&=(cancelAnimationFrame(C.current),null)}dispose(){try{if(window.removeEventListener(`resize`,this._resize),document.removeEventListener(`visibilitychange`,this._onVisibility),k.dispose(),O.renderer){let e=O.renderer.domElement;e&&e.parentNode&&e.parentNode.removeChild(e),O.renderer.dispose(),O.renderer.forceContextLoss()}}catch{}}}let le=b.current;le.style.position=le.style.position||`relative`,le.style.overflow=le.style.overflow||`hidden`;let ue=new P({$wrapper:le,autoDemo:p,autoSpeed:m,autoIntensity:h,takeoverDuration:g,autoResumeDelay:v,autoRampDuration:y});x.current=ue,(()=>{if(!x.current)return;let u=x.current.output?.simulation;if(!u)return;let d=u.options.resolution;Object.assign(u.options,{mouse_force:e,cursor_size:t,isViscous:n,viscous:r,iterations_viscous:i,iterations_poisson:a,dt:o,BFECC:s,resolution:c,isBounce:l}),c!==d&&u.resize()})(),ue.start();let de=new IntersectionObserver(e=>{let t=e[0],n=t.isIntersecting&&t.intersectionRatio>0;T.current=n,x.current&&(n&&!document.hidden?x.current.start():x.current.pause())},{threshold:[0,.01,.1]});de.observe(le),w.current=de;let fe=new ResizeObserver(()=>{x.current&&(E.current&&cancelAnimationFrame(E.current),E.current=requestAnimationFrame(()=>{x.current&&x.current.resize()}))});return fe.observe(le),S.current=fe,()=>{if(C.current&&cancelAnimationFrame(C.current),S.current)try{S.current.disconnect()}catch{}if(w.current)try{w.current.disconnect()}catch{}x.current&&x.current.dispose(),x.current=null}},[s,t,o,l,n,a,i,e,c,r,u,p,m,h,g,v,y]),(0,_.useEffect)(()=>{let u=x.current;if(!u)return;let d=u.output?.simulation;if(!d)return;let f=d.options.resolution;Object.assign(d.options,{mouse_force:e,cursor_size:t,isViscous:n,viscous:r,iterations_viscous:i,iterations_poisson:a,dt:o,BFECC:s,resolution:c,isBounce:l}),u.autoDriver&&(u.autoDriver.enabled=p,u.autoDriver.speed=m,u.autoDriver.resumeDelay=v,u.autoDriver.rampDurationMs=y*1e3,u.autoDriver.mouse&&(u.autoDriver.mouse.autoIntensity=h,u.autoDriver.mouse.takeoverDuration=g)),c!==f&&d.resize()},[e,t,n,r,i,a,o,s,c,l,p,m,h,g,v,y]),(0,Q.jsx)(`div`,{ref:b,className:`liquid-ether-container ${f||``}`,style:d})}var Dl=`/MyPortfolio/assets/profilePic-DWa4lptf.png`,Ol=`/MyPortfolio/assets/hotel-1-CoaCumux.png`,kl=`/MyPortfolio/assets/hotel-2-CzYqcJLv.png`,Al=`/MyPortfolio/assets/hotel-3-B0U-KCTF.png`,jl=`/MyPortfolio/assets/VR%20-%201-BCgeTetd.png`,Ml=`/MyPortfolio/assets/VR%20-%202-4p6zVZo8.png`,Nl=`/MyPortfolio/assets/VR%20-%203-DrFw1ytk.png`,$=`/MyPortfolio/assets/VR%20-%204-IL-fNfEJ.png`,Pl=`/MyPortfolio/assets/JavaLogo-aO9tEvay.png`,Fl=`/MyPortfolio/assets/SpringLogo-DCQwC5hs.png`,Il=`/MyPortfolio/assets/MySQLLogo-DeFRnxot.png`,Ll=({children:e,className:t=``,delay:n=0})=>{let[r,i]=(0,_.useState)(!1),a=(0,_.useRef)(null);return(0,_.useEffect)(()=>{let e=new IntersectionObserver(([t])=>{t.isIntersecting&&(i(!0),e.unobserve(t.target))},{threshold:.1,rootMargin:`0px 0px -50px 0px`});return a.current&&e.observe(a.current),()=>e.disconnect()},[]),(0,Q.jsx)(`div`,{ref:a,style:{transitionDelay:`${n}ms`},className:`transition-all duration-1000 ease-out ${r?`opacity-100 translate-y-0`:`opacity-0 translate-y-12`} ${t}`,children:e})};function Rl(){let[e,t]=(0,_.useState)(`technical`),[n,r]=(0,_.useState)(!1),[i,a]=(0,_.useState)([{sender:`ai`,text:`Hi! I'm Sahiru's virtual assistant. Ask me anything about his skills, projects, or CV!`}]),[o,s]=(0,_.useState)(``),[c,l]=(0,_.useState)(!1),u=(0,_.useRef)(null),[d,f]=(0,_.useState)(null),[p,m]=(0,_.useState)(null),h=[{id:1,title:`AWS Foundations: Machine Learning Basics`,issuer:`AWS Training & Certification`,year:`2026`,file:`ML_spec_AWS.pdf`},{id:2,title:`Programming in Python - Python for Beginners`,issuer:`University of Moratuwa`,year:`2026`,file:`Python_for_Beginners_E-Certificate.pdf`}],g=(0,_.useRef)(null),v=e=>{g.current&&g.current.scrollBy({left:e===`left`?-350:350,behavior:`smooth`})},y=[{id:`hotel`,title:`Hotel Management System`,icon:(0,Q.jsx)(ve,{size:24,className:`text-indigo-400`}),themeColor:`text-indigo-400`,btnColor:`bg-indigo-600 hover:bg-indigo-500`,gradient:`from-blue-500 to-indigo-500`,tags:[`Python`,`Tkinter`],shortDesc:`A light weight desktop based Graphical User Interface (GUI) application to help in booking hotels and manage guest data efficiently. The project is written entirely in Python and demonstrates practical skills in state management, input validation and file handling.`,features:[`Developed using Python and the Tkinter GUI library`,`Advanced file handling and data structure management`,`Secure user authentication and session handling`,`Algorithmic logic for room allocation and billing`],gallery:[Ol,kl,Al],githubLink:`https://github.com/Sahiru1010/Hotel-Management-System.git`,reportLink:`HotelM.pdf`},{id:`vehicle`,title:`Vehicle Rental Platform`,icon:(0,Q.jsx)(ce,{size:24,className:`text-purple-400`}),themeColor:`text-purple-400`,btnColor:`bg-purple-600 hover:bg-purple-500`,gradient:`from-purple-500 to-pink-500`,tags:[`TypeScript`,`JavaScript`,`CSS`],shortDesc:`A modern web application scalable and designed to simplify the operations of vehicle fleet management and vehicle rentals. The platform is hosted on Vercel, ensuring high-performance hosting and delivering a seamless and responsive user experience for browsing, filtering, and interacting with dynamic vehicle inventories.`,features:[`Scalable architecture designed for enterprise vehicle fleets`,`Integration of unique rental service features and constraints`,`Comprehensive system design documentation`,`Researched and structured for a university BIT project`],gallery:[jl,Ml,Nl,$],githubLink:`https://github.com/OpenStag/project-15.git`},{id:`content`,title:`Ongoing Hospital Management System`,icon:(0,Q.jsx)(ae,{size:24,className:`text-pink-400`}),themeColor:`text-pink-400`,btnColor:`bg-pink-600 hover:bg-pink-500`,gradient:`from-pink-500 to-rose-500`,tags:[`Java`,`Spring Boot`,`MySQL`,`Spring Data JPA/Hibernate`],shortDesc:`A complete enterprise backend system for hospital operations, providing RESTful APIs with security. The application is built 100% in Java and Spring Boot and provides seamless integration of complex relational databases with a strong object-oriented software architecture.`,features:[`Targeted brand architecture (US News and Culture, Meow Moments, GG HUB)`,`Custom logo generation and niche-specific bio engineering`,`Audience engagement tactics for Facebook, TikTok, and YouTube`,`Cross-platform monetization and content scaling strategies`],gallery:[Pl,Fl,Il],githubLink:`https://github.com/yourusername/social-networks`}],b=e=>{let t=e.toLowerCase();return t.includes(`hi`)||t.includes(`hello`)||t.includes(`hey`)?`Hello! I'm Sahiru's AI assistant. Ask me about his skills, education, projects, or how to contact him!`:t.includes(`skill`)||t.includes(`tech`)||t.includes(`tools`)?`Sahiru specializes in Python, Java, Spring Boot, React, and MySQL. He's also highly focused on Data Science and Machine Learning!`:t.includes(`project`)||t.includes(`portfolio`)||t.includes(`work`)?`Sahiru has developed great projects like a Hotel Management System (Python), a Vehicle Rental Platform (TypeScript/React), and an ongoing Hospital Management System (Java/Spring Boot).`:t.includes(`education`)||t.includes(`degree`)||t.includes(`sltc`)||t.includes(`ucsc`)?`He is pursuing a dual degree! A BSc (Hons) in Data Science at SLTC, and a Bachelor of Information Technology (BIT) at UCSC.`:t.includes(`contact`)||t.includes(`email`)||t.includes(`phone`)||t.includes(`hire`)?`You can reach Sahiru directly at sahirusandeepa52@gmail.com or call him at +94 70 213 2649.`:t.includes(`cv`)||t.includes(`resume`)?`You can easily download his full CV using the 'Access CV' button in the About section at the top of the page!`:`That's an interesting question! I'm a simple demo assistant, but you can find most details by exploring the portfolio sections above or downloading his CV.`};return(0,_.useEffect)(()=>{u.current&&n&&u.current.scrollIntoView({behavior:`smooth`})},[i,c,n]),(0,_.useEffect)(()=>{window.scrollTo({top:0,left:0,behavior:`instant`}),window.location.hash&&window.history.replaceState(null,``,window.location.pathname)},[]),(0,Q.jsxs)(Q.Fragment,{children:[(0,Q.jsx)(`div`,{className:`fixed inset-0 z-[-2]`,children:(0,Q.jsx)(El,{colors:[`#5227FF`,`#FF9FFC`,`#B497CF`],mouseForce:20,cursorSize:100,isViscous:!0,viscous:20,iterationsViscous:8,iterationsPoisson:8,resolution:.25,isBounce:!1,autoDemo:!0,autoSpeed:.5,autoIntensity:2.2,takeoverDuration:.25,autoResumeDelay:3e3,autoRampDuration:.6,color0:`#13083e`,color1:`#052aff`,color2:`#01021a`})}),(0,Q.jsx)(`style`,{children:`
      ...
      `}),(0,Q.jsx)(`div`,{className:`blob bg-blue-600/30 w-96 h-96 top-[-10%] left-[-10%]`}),(0,Q.jsx)(`div`,{className:`blob bg-purple-600/20 w-[30rem] h-[30rem] bottom-[-10%] right-[-10%]`,style:{animationDelay:`-5s`}}),(0,Q.jsxs)(`div`,{className:`min-h-screen font-sans selection:bg-indigo-500/30 selection:text-indigo-200`,children:[(0,Q.jsx)(`nav`,{className:`fixed w-full top-0 z-50 p-4 flex justify-center pointer-events-none`,children:(0,Q.jsxs)(`div`,{className:`glass pointer-events-auto rounded-full px-6 py-3 flex items-center gap-8 shadow-2xl shadow-black/50 transition-all`,children:[(0,Q.jsxs)(`span`,{className:`font-bold text-lg text-white tracking-wider flex items-center gap-2`,children:[(0,Q.jsx)(N,{size:18,className:`text-indigo-400`}),` Sahiru Sandeepa`]}),(0,Q.jsxs)(`div`,{className:`hidden md:flex items-center gap-6 text-sm font-medium text-slate-300`,children:[(0,Q.jsx)(`a`,{href:`#about`,className:`hover:text-white transition-all`,children:`About Me`}),(0,Q.jsx)(`a`,{href:`#education`,className:`hover:text-white transition-all`,children:`Education`}),(0,Q.jsx)(`a`,{href:`#projects`,className:`hover:text-white transition-all`,children:`Projects`}),(0,Q.jsx)(`a`,{href:`#contact`,className:`hover:text-white transition-all`,children:`Connect`})]})]})}),(0,Q.jsxs)(`section`,{id:`about`,className:`relative pt-40 pb-20 px-6 lg:pt-48 lg:pb-32 max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center gap-16`,children:[(0,Q.jsxs)(`div`,{className:`flex-1 space-y-8 z-10`,children:[(0,Q.jsxs)(Ll,{children:[(0,Q.jsx)(`div`,{className:`inline-flex items-center gap-2 px-3 py-1 rounded-full glass text-indigo-300 text-sm font-medium mb-4`,children:(0,Q.jsx)(ce,{size:14})}),(0,Q.jsxs)(`h1`,{className:`text-5xl lg:text-7xl font-extrabold tracking-tight text-white leading-tight`,children:[`Designing Data.`,(0,Q.jsx)(`br`,{}),(0,Q.jsx)(`span`,{className:`text-gradient`,children:`Building Future.`})]})]}),(0,Q.jsx)(Ll,{delay:200,children:(0,Q.jsxs)(`p`,{className:`text-lg text-slate-400 leading-relaxed max-w-2xl border-l-2 border-indigo-500/50 pl-6`,children:[(0,Q.jsx)(`strong`,{children:`I'm Sahiru Sandeepa`}),` an undergraduate pursuing dual degrees in Data Science and Software Engineering. With a strong focus on Artificial Intelligence, Machine Learning, complex data analysis and Full Stack Development.`]})}),(0,Q.jsx)(Ll,{delay:400,className:`flex flex-wrap gap-5 pt-4`,children:(0,Q.jsxs)(`div`,{className:`flex flex-wrap items-center gap-6 pt-6`,children:[(0,Q.jsxs)(`div`,{className:`flex flex-wrap gap-4`,children:[(0,Q.jsxs)(`a`,{href:`#contact`,className:`px-8 py-4 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-bold transition-all hover:scale-105 hover:shadow-[0_0_30px_rgba(79,70,229,0.4)] flex items-center gap-2 group`,children:[`Get in Touch `,(0,Q.jsx)(ge,{className:`group-hover:translate-x-1 transition-transform`})]}),(0,Q.jsxs)(`a`,{href:`MyCV.pdf`,download:!0,className:`px-8 py-4 rounded-xl bg-slate-900 border border-white/10 hover:bg-slate-800 text-white font-bold transition-all hover:scale-105 flex items-center gap-2`,children:[(0,Q.jsx)(pe,{}),` Access CV`]})]}),(0,Q.jsx)(`div`,{className:`hidden sm:block w-px h-12 bg-white/10 rounded-full`}),(0,Q.jsxs)(`div`,{className:`flex gap-5 mt-8 lg:mt-0`,children:[(0,Q.jsx)(`div`,{className:`animate-floating`,style:{animationDelay:`0s`},children:(0,Q.jsx)(`a`,{href:`https://github.com/Sahiru1010`,target:`_blank`,rel:`noopener noreferrer`,className:`w-12 h-12 rounded-xl bg-slate-900/80 border-2 border-indigo-500/60 shadow-[0_0_12px_rgba(99,102,241,0.5)] flex items-center justify-center text-indigo-400 hover:text-white hover:bg-indigo-500/20 hover:border-indigo-400 hover:shadow-[0_0_25px_rgba(99,102,241,0.9)] transition-all duration-300`,children:(0,Q.jsx)(j,{size:20})})}),(0,Q.jsx)(`div`,{className:`animate-floating`,style:{animationDelay:`0.2s`},children:(0,Q.jsx)(`a`,{href:`https://www.linkedin.com/in/sahiru-sandeepa-9b1914267/`,target:`_blank`,rel:`noopener noreferrer`,className:`w-12 h-12 rounded-xl bg-slate-900/80 border-2 border-blue-500/60 shadow-[0_0_12px_rgba(59,130,246,0.5)] flex items-center justify-center text-blue-400 hover:text-white hover:bg-blue-500/20 hover:border-blue-400 hover:shadow-[0_0_25px_rgba(59,130,246,0.9)] transition-all duration-300`,children:(0,Q.jsx)(ie,{size:20})})}),(0,Q.jsx)(`div`,{className:`animate-floating`,style:{animationDelay:`0.4s`},children:(0,Q.jsx)(`a`,{href:`mailto:sahirusandeepa52@gmail.com`,target:`_blank`,rel:`noopener noreferrer`,className:`w-12 h-12 rounded-xl bg-slate-900/80 border-2 border-emerald-500/60 shadow-[0_0_12px_rgba(16,185,129,0.5)] flex items-center justify-center text-emerald-400 hover:text-white hover:bg-emerald-500/20 hover:border-emerald-400 hover:shadow-[0_0_25px_rgba(16,185,129,0.9)] transition-all duration-300`,children:(0,Q.jsx)(fe,{size:20})})})]})]})})]}),(0,Q.jsx)(`div`,{className:`flex-1 flex justify-center lg:justify-end z-10`,children:(0,Q.jsx)(Ll,{delay:300,children:(0,Q.jsxs)(`div`,{className:`relative group`,children:[(0,Q.jsx)(`div`,{className:`absolute inset-0 bg-indigo-500 rounded-3xl blur-2xl opacity-20 group-hover:opacity-40 transition-opacity duration-500 translate-y-10 -translate-x-10`}),(0,Q.jsx)(`div`,{className:`absolute -inset-1 bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 rounded-3xl opacity-50 group-hover:opacity-100 transition-opacity duration-500`,style:{filter:`blur(2px)`}}),(0,Q.jsxs)(`div`,{className:`relative group mt-8 md:mt-0`,children:[(0,Q.jsx)(`div`,{className:`relative w-64 h-64 lg:w-[350px] lg:h-[350px] rounded-3xl overflow-hidden bg-slate-900 border border-white/10 z-10 shadow-2xl`,children:(0,Q.jsx)(`img`,{src:Dl,alt:`Sahiru Sandeepa`,className:`w-full h-full object-cover opacity-90 group-hover:opacity-100 group-hover:scale-105 transition-all duration-700`})}),(0,Q.jsxs)(`div`,{className:`absolute -top-12 left-1/2 -translate-x-1/2 z-20 bg-slate-800/80 backdrop-blur-xl px-5 py-2.5 rounded-2xl flex items-center gap-3 border border-white/5 shadow-2xl animate-floating whitespace-nowrap`,children:[(0,Q.jsx)(`span`,{className:`w-2.5 h-2.5 rounded-full bg-emerald-500 shadow-[0_0_10px_rgba(16,185,129,0.8)] animate-pulse`}),(0,Q.jsx)(`span`,{className:`text-1xl font-bold text-slate-200 tracking-wide`,children:`Data Science and AI Enthusiast`})]})]})]})})})]}),(0,Q.jsxs)(`section`,{id:`education`,className:`py-24 px-6 max-w-5xl mx-auto relative z-10`,children:[(0,Q.jsx)(Ll,{children:(0,Q.jsxs)(`div`,{className:`flex items-center gap-4 mb-16`,children:[(0,Q.jsx)(`div`,{className:`h-[1px] flex-1 bg-gradient-to-r from-transparent to-indigo-500/50`}),(0,Q.jsxs)(`h2`,{className:`text-4xl font-bold tracking-tight`,children:[(0,Q.jsx)(`span`,{className:`text-gradient`,children:`Journey`}),` and Milestones`]}),(0,Q.jsx)(`div`,{className:`h-[1px] flex-1 bg-gradient-to-l from-transparent to-indigo-500/50`})]})}),(0,Q.jsxs)(`div`,{className:`relative border-l border-white/10 ml-4 md:ml-0 md:pl-0 space-y-12`,children:[(0,Q.jsxs)(Ll,{delay:100,className:`relative pl-8 md:pl-12 group`,children:[(0,Q.jsx)(`div`,{className:`absolute w-10 h-10 bg-slate-900 border border-indigo-500/50 rounded-full flex items-center justify-center -left-5 top-0 group-hover:border-indigo-400 transition-all`,children:(0,Q.jsx)(de,{size:20,className:`text-indigo-400`})}),(0,Q.jsxs)(`div`,{className:`glass glass-card p-8 rounded-2xl transition-all duration-300`,children:[(0,Q.jsx)(`span`,{className:`text-indigo-400 text-lg font-bold tracking-wider mb-2 block uppercase`,children:`Education Details`}),(0,Q.jsx)(`br`,{}),(0,Q.jsx)(`h3`,{className:`text-2xl font-bold text-white mb-2`,children:`BSc (Hons) in Data Science`}),(0,Q.jsx)(`h4`,{className:`text-lg text-slate-300 mb-4 font-medium`,children:`Sri Lanka Technological Campus (SLTC)`}),(0,Q.jsx)(`p`,{className:`text-slate-400 leading-relaxed`,children:`Currently pursuing a degree with strong academic focus on Artificial Intelligence, Machine Learning, Big Data Analytics, and complex statistical modelling.`}),(0,Q.jsx)(`br`,{}),(0,Q.jsx)(`h3`,{className:`text-2xl font-bold text-white mb-2`,children:`Bachelor of Information Technology (BIT)`}),(0,Q.jsx)(`h4`,{className:`text-lg text-slate-300 mb-4 font-medium`,children:`University of Colombo School Of Computing (UCSC)`}),(0,Q.jsx)(`p`,{className:`text-slate-400 leading-relaxed`,children:`This external degree program specially focus on Software Engineering, Full-Stack Development and complex systems architecture.`})]})]}),(0,Q.jsxs)(Ll,{delay:200,className:`relative pl-8 md:pl-12 group`,children:[(0,Q.jsx)(`div`,{className:`absolute w-10 h-10 bg-slate-900 border border-purple-500/50 rounded-full flex items-center justify-center -left-5 top-0 group-hover:border-purple-400 transition-all`,children:(0,Q.jsx)(he,{size:20,className:`text-purple-400`})}),(0,Q.jsxs)(`div`,{className:`glass glass-card p-8 rounded-2xl transition-all duration-300`,children:[(0,Q.jsx)(`span`,{className:`text-purple-400 text-lg font-bold tracking-wider mb-2 block uppercase`,children:`Skills`}),(0,Q.jsx)(`br`,{}),(0,Q.jsxs)(`div`,{className:`bg-[#1a202c]/80 border border-white/5 rounded-xl p-2 flex flex-wrap gap-2 mb-4 shadow-inner`,children:[(0,Q.jsxs)(`button`,{onClick:()=>t(`technical`),className:`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-semibold transition-all ${e===`technical`?`bg-slate-700 text-cyan-400 shadow-md`:`text-slate-400 hover:text-slate-300 hover:bg-slate-800/50`}`,children:[(0,Q.jsx)(he,{size:14}),` Technical`]}),(0,Q.jsxs)(`button`,{onClick:()=>t(`tools`),className:`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-semibold transition-all ${e===`tools`?`bg-slate-700 text-cyan-400 shadow-md`:`text-slate-400 hover:text-slate-300 hover:bg-slate-800/50`}`,children:[(0,Q.jsx)(oe,{size:14}),` Tools`]}),(0,Q.jsxs)(`button`,{onClick:()=>t(`soft`),className:`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-semibold transition-all ${e===`soft`?`bg-slate-700 text-cyan-400 shadow-md`:`text-slate-400 hover:text-slate-300 hover:bg-slate-800/50`}`,children:[(0,Q.jsx)(M,{size:14}),` Soft Skills`]})]}),(0,Q.jsxs)(`div`,{className:`bg-[#1a202c]/60 border border-white/5 rounded-xl p-6 shadow-lg`,children:[(0,Q.jsxs)(`h4`,{className:`text-lg font-bold text-white mb-5`,children:[e===`technical`&&`Technical Skills`,e===`tools`&&`Design & Development Tools`,e===`soft`&&`Interpersonal Skills`]}),(0,Q.jsxs)(`div`,{className:`flex flex-wrap gap-3`,children:[e===`technical`&&(0,Q.jsxs)(Q.Fragment,{children:[(0,Q.jsx)(`span`,{className:`px-4 py-2 bg-[#1e293b] border border-white/5 text-cyan-400 text-sm font-medium rounded-full cursor-default hover:bg-slate-700 transition-colors`,children:`Java`}),(0,Q.jsx)(`span`,{className:`px-4 py-2 bg-[#1e293b] border border-white/5 text-cyan-400 text-sm font-medium rounded-full cursor-default hover:bg-slate-700 transition-colors`,children:`Java Springboot`}),(0,Q.jsx)(`span`,{className:`px-4 py-2 bg-[#1e293b] border border-white/5 text-cyan-400 text-sm font-medium rounded-full cursor-default hover:bg-slate-700 transition-colors`,children:`Python`}),(0,Q.jsx)(`span`,{className:`px-4 py-2 bg-[#1e293b] border border-white/5 text-cyan-400 text-sm font-medium rounded-full cursor-default hover:bg-slate-700 transition-colors`,children:`JavaScript`}),(0,Q.jsx)(`span`,{className:`px-4 py-2 bg-[#1e293b] border border-white/5 text-cyan-400 text-sm font-medium rounded-full cursor-default hover:bg-slate-700 transition-colors`,children:`React`}),(0,Q.jsx)(`span`,{className:`px-4 py-2 bg-[#1e293b] border border-white/5 text-cyan-400 text-sm font-medium rounded-full cursor-default hover:bg-slate-700 transition-colors`,children:`HTML/CSS`}),(0,Q.jsx)(`span`,{className:`px-4 py-2 bg-[#1e293b] border border-white/5 text-cyan-400 text-sm font-medium rounded-full cursor-default hover:bg-slate-700 transition-colors`,children:`My SQL`})]}),e===`tools`&&(0,Q.jsxs)(Q.Fragment,{children:[(0,Q.jsx)(`span`,{className:`px-4 py-2 bg-[#1e293b] border border-white/5 text-cyan-400 text-sm font-medium rounded-full cursor-default hover:bg-slate-700 transition-colors`,children:`IntelliJ IDEA`}),(0,Q.jsx)(`span`,{className:`px-4 py-2 bg-[#1e293b] border border-white/5 text-cyan-400 text-sm font-medium rounded-full cursor-default hover:bg-slate-700 transition-colors`,children:`VS Code`}),(0,Q.jsx)(`span`,{className:`px-4 py-2 bg-[#1e293b] border border-white/5 text-cyan-400 text-sm font-medium rounded-full cursor-default hover:bg-slate-700 transition-colors`,children:`Figma`}),(0,Q.jsx)(`span`,{className:`px-4 py-2 bg-[#1e293b] border border-white/5 text-cyan-400 text-sm font-medium rounded-full cursor-default hover:bg-slate-700 transition-colors`,children:`GitHub`}),(0,Q.jsx)(`span`,{className:`px-4 py-2 bg-[#1e293b] border border-white/5 text-cyan-400 text-sm font-medium rounded-full cursor-default hover:bg-slate-700 transition-colors`,children:`MongoDB`}),(0,Q.jsx)(`span`,{className:`px-4 py-2 bg-[#1e293b] border border-white/5 text-cyan-400 text-sm font-medium rounded-full cursor-default hover:bg-slate-700 transition-colors`,children:`Postman`})]}),e===`soft`&&(0,Q.jsxs)(Q.Fragment,{children:[(0,Q.jsx)(`span`,{className:`px-4 py-2 bg-[#1e293b] border border-white/5 text-cyan-400 text-sm font-medium rounded-full cursor-default hover:bg-slate-700 transition-colors`,children:`Analytical & Critical Thinking`}),(0,Q.jsx)(`span`,{className:`px-4 py-2 bg-[#1e293b] border border-white/5 text-cyan-400 text-sm font-medium rounded-full cursor-default hover:bg-slate-700 transition-colors`,children:`Communication`}),(0,Q.jsx)(`span`,{className:`px-4 py-2 bg-[#1e293b] border border-white/5 text-cyan-400 text-sm font-medium rounded-full cursor-default hover:bg-slate-700 transition-colors`,children:`Problem Solving`}),(0,Q.jsx)(`span`,{className:`px-4 py-2 bg-[#1e293b] border border-white/5 text-cyan-400 text-sm font-medium rounded-full cursor-default hover:bg-slate-700 transition-colors`,children:`Leadership`})]})]})]})]})]}),(0,Q.jsxs)(Ll,{delay:300,className:`relative pl-8 md:pl-12 group`,children:[(0,Q.jsx)(`div`,{className:`absolute w-10 h-10 bg-slate-900 border border-pink-500/50 rounded-full flex items-center justify-center -left-5 top-0 group-hover:border-pink-400 transition-all shadow-[0_0_15px_rgba(236,72,153,0.2)]`,children:(0,Q.jsx)(ye,{size:20,className:`text-pink-400`})}),(0,Q.jsxs)(`div`,{className:`glass glass-card p-8 rounded-2xl transition-all duration-300`,children:[(0,Q.jsx)(`span`,{className:`text-pink-400 text-lg font-bold tracking-wider mb-4 block uppercase`,children:`Achievements & Certifications`}),(0,Q.jsxs)(`div`,{className:`mb-6`,children:[(0,Q.jsx)(`h3`,{className:`text-xl font-bold text-white mb-2`,children:`Professional Certificates`}),(0,Q.jsx)(`p`,{className:`text-slate-400 leading-relaxed text-1xl font-semibold`,children:`I earned some professional certificates in Data Science, Machine Learning, and Software Development. These certifications validate my expertise, as well as my commitment to lifelong learning in an ever-evolving tech landscape.`})]}),(0,Q.jsx)(`div`,{className:`w-full h-px bg-gradient-to-r from-pink-500/50 via-purple-500/30 to-transparent mb-6`}),(0,Q.jsx)(`h4`,{className:`text-md font-bold text-slate-200 mb-4`,children:`Professional Certificates`}),(0,Q.jsx)(`ul`,{className:`space-y-3`,children:h.map(e=>(0,Q.jsxs)(`li`,{className:`flex items-center justify-between gap-3 p-3 rounded-xl hover:bg-slate-800/40 border border-transparent hover:border-white/5 transition-all group/cert`,children:[(0,Q.jsxs)(`div`,{className:`flex items-start gap-3`,children:[(0,Q.jsx)(`span`,{className:`text-pink-500 mt-1 group-hover/cert:translate-x-1 transition-transform`,children:(0,Q.jsx)(ge,{size:14})}),(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`h5`,{className:`text-white font-semibold text-1xl`,children:e.title}),(0,Q.jsxs)(`p`,{className:`text-slate-400 text-1xl mt-1 font-semibold`,children:[e.issuer,` • `,e.year]})]})]}),(0,Q.jsx)(`button`,{onClick:()=>m(e),className:`text-xs font-bold px-4 py-2 bg-pink-500/10 text-pink-400 hover:bg-pink-500 hover:text-white rounded-lg transition-colors border border-pink-500/20 whitespace-nowrap shadow-sm hover:shadow-[0_0_15px_rgba(236,72,153,0.4)]`,children:`Show Credentials`})]},e.id))})]})]})]})]}),(0,Q.jsxs)(`section`,{id:`projects`,className:`py-24 px-6 max-w-7xl mx-auto relative z-10`,children:[(0,Q.jsx)(Ll,{children:(0,Q.jsx)(`div`,{className:`flex flex-col md:flex-row items-start md:items-end justify-between mb-12 gap-4`,children:(0,Q.jsxs)(`div`,{children:[(0,Q.jsxs)(`h2`,{className:`text-4xl font-bold tracking-tight mb-2`,children:[`Featured `,(0,Q.jsx)(`span`,{className:`text-gradient`,children:`Projects`})]}),(0,Q.jsx)(`p`,{className:`text-slate-400`,children:`A comprehensive showcase of deployed systems, ongoing research, and completed technical works.`})]})})}),(0,Q.jsx)(`div`,{className:`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6`,children:y.map((e,t)=>(0,Q.jsx)(Ll,{delay:(t+1)*100,className:`h-full`,children:(0,Q.jsxs)(`div`,{className:`glass glass-card p-8 rounded-3xl h-full flex flex-col transition-all duration-500 group relative overflow-hidden`,children:[(0,Q.jsx)(`div`,{className:`absolute top-0 left-0 w-full h-1 bg-gradient-to-r ${e.gradient} transform origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-500`}),(0,Q.jsx)(`div`,{className:`bg-slate-800/50 w-14 h-14 rounded-2xl flex items-center justify-center mb-6 border border-white/5`,children:e.icon}),(0,Q.jsx)(`h3`,{className:`text-2xl font-bold text-white mb-3`,children:e.title}),(0,Q.jsx)(`div`,{className:`flex flex-wrap gap-2 mb-6`,children:e.tags.map(e=>(0,Q.jsx)(`span`,{className:`px-2 py-1 bg-slate-800 border border-slate-700 rounded-md text-xs font-mono text-slate-300`,children:e},e))}),(0,Q.jsx)(`p`,{className:`text-slate-400 mb-8 flex-1`,children:e.shortDesc}),(0,Q.jsxs)(`button`,{onClick:()=>f(e),className:`flex items-center gap-2 ${e.themeColor} font-semibold mt-auto group-hover:brightness-125 transition-all text-left`,children:[`Inspect System `,(0,Q.jsx)(ge,{size:18,className:`group-hover:translate-x-1 transition-transform`})]})]})},e.id))})]}),d&&(0,Q.jsxs)(`div`,{className:`fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6`,children:[(0,Q.jsx)(`div`,{className:`absolute inset-0 bg-slate-950/60 backdrop-blur-xl animate-fade-in cursor-pointer`,onClick:()=>f(null)}),(0,Q.jsxs)(`div`,{className:`relative glass bg-slate-900/95 border border-white/10 rounded-3xl w-full max-w-4xl max-h-[90vh] flex flex-col shadow-2xl animate-pop-in`,children:[(0,Q.jsxs)(`div`,{className:`flex justify-between items-center p-6 border-b border-white/10`,children:[(0,Q.jsxs)(`h3`,{className:`text-2xl font-bold text-white flex items-center gap-3`,children:[d.icon,` `,d.title]}),(0,Q.jsx)(`button`,{onClick:()=>f(null),className:`text-slate-400 hover:text-white transition-colors p-2 rounded-full hover:bg-white/5`,children:(0,Q.jsx)(se,{size:24})})]}),(0,Q.jsxs)(`div`,{className:`p-6 overflow-y-auto custom-scrollbar flex-1`,children:[(0,Q.jsx)(`h4`,{className:`text-lg font-bold text-white mb-4 flex items-center gap-2`,children:`System Gallery`}),(0,Q.jsxs)(`div`,{className:`relative mb-8 group`,children:[(0,Q.jsx)(`button`,{onClick:()=>v(`left`),className:`absolute left-2 top-1/2 -translate-y-1/2 z-10 bg-slate-900/80 hover:bg-slate-800 border border-white/10 p-3 rounded-full text-white opacity-0 group-hover:opacity-100 transition-all shadow-lg backdrop-blur-sm`,children:(0,Q.jsx)(_e,{size:16})}),(0,Q.jsx)(`div`,{ref:g,className:`flex overflow-x-auto gap-4 snap-x snap-mandatory scroll-smooth pb-4 custom-scrollbar`,children:d.gallery.map((e,t)=>(0,Q.jsx)(`img`,{src:e,className:`snap-center shrink-0 rounded-xl border border-white/10 w-[90%] sm:w-[75%] md:w-[60%] h-56 md:h-72 object-cover shadow-lg`,alt:`${d.title} screenshot ${t+1}`},t))}),(0,Q.jsx)(`button`,{onClick:()=>v(`right`),className:`absolute right-2 top-1/2 -translate-y-1/2 z-10 bg-slate-900/80 hover:bg-slate-800 border border-white/10 p-3 rounded-full text-white opacity-0 group-hover:opacity-100 transition-all shadow-lg backdrop-blur-sm`,children:(0,Q.jsx)(ge,{size:16})})]}),(0,Q.jsx)(`h4`,{className:`text-lg font-bold text-white mb-4 flex items-center gap-2`,children:`Architecture & Features`}),(0,Q.jsx)(`div`,{className:`bg-slate-950/50 rounded-xl p-5 border border-white/5`,children:(0,Q.jsx)(`ul`,{className:`space-y-4`,children:d.features.map((e,t)=>(0,Q.jsxs)(`li`,{className:`flex items-start gap-3 text-slate-300`,children:[(0,Q.jsx)(`span`,{className:`${d.themeColor} mt-1`,children:(0,Q.jsx)(ge,{size:14})}),(0,Q.jsx)(`span`,{className:`leading-relaxed`,children:e})]},t))})})]}),(0,Q.jsxs)(`div`,{className:`flex gap-8 p-6 border-t border-white/10 bg-slate-950/50 flex justify-end rounded-b-3xl`,children:[d.reportLink&&(0,Q.jsxs)(`a`,{href:d.reportLink,download:!0,className:`px-6 py-3 bg-slate-800 hover:bg-slate-700 text-white font-bold rounded-xl border border-white/10 transition-all flex items-center gap-2 shadow-lg`,children:[(0,Q.jsx)(pe,{size:18,className:`text-slate-300`}),` Download Report`]}),(0,Q.jsxs)(`a`,{href:d.githubLink,target:`_blank`,rel:`noreferrer`,className:`px-6 py-3 ${d.btnColor} text-white font-bold rounded-xl transition-all flex items-center gap-2 shadow-lg`,children:[(0,Q.jsx)(j,{size:20}),` Access Source Code`]})]})]})]}),p&&(0,Q.jsxs)(`div`,{className:`fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6`,children:[(0,Q.jsx)(`div`,{className:`absolute inset-0 bg-slate-950/60 backdrop-blur-xl animate-fade-in cursor-pointer`,onClick:()=>m(null)}),(0,Q.jsxs)(`div`,{className:`relative glass bg-slate-900/95 border border-white/10 rounded-3xl w-full max-w-4xl h-[85vh] flex flex-col shadow-2xl animate-pop-in`,children:[(0,Q.jsxs)(`div`,{className:`flex justify-between items-center p-6 border-b border-white/10`,children:[(0,Q.jsxs)(`h3`,{className:`text-xl font-bold text-white flex items-center gap-3`,children:[(0,Q.jsx)(ye,{className:`text-pink-400`,size:24}),` `,p.title]}),(0,Q.jsx)(`button`,{onClick:()=>m(null),className:`text-slate-400 hover:text-white transition-colors p-2 rounded-full hover:bg-white/5`,children:(0,Q.jsx)(se,{size:24})})]}),(0,Q.jsx)(`div`,{className:`flex-1 w-full bg-slate-950/50 p-2 sm:p-6 rounded-b-3xl`,children:(0,Q.jsx)(`iframe`,{src:`${p.file}#toolbar=0&navpanes=0`,className:`w-full h-full rounded-xl border border-white/10 bg-slate-800`,title:p.title})})]})]}),(0,Q.jsxs)(`footer`,{id:`contact`,className:`relative mt-32 bg-[#020617] overflow-hidden border-t border-white/10`,children:[(0,Q.jsx)(`div`,{className:`absolute top-0 left-1/2 -translate-x-1/2 w-3/4 h-px bg-gradient-to-r from-transparent via-indigo-500/70 to-transparent`}),(0,Q.jsx)(`div`,{className:`absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[300px] bg-indigo-600/10 blur-[120px] rounded-full pointer-events-none`}),(0,Q.jsxs)(`div`,{className:`max-w-7xl mx-auto px-6 pt-20 pb-10 relative z-10`,children:[(0,Q.jsxs)(`div`,{className:`grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-8 mb-16`,children:[(0,Q.jsx)(`div`,{className:`col-span-1`,children:(0,Q.jsxs)(Ll,{delay:100,className:`space-y-6`,children:[(0,Q.jsxs)(`div`,{className:`flex items-center gap-3`,children:[(0,Q.jsx)(`div`,{className:`w-12 h-12 rounded-xl bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center shadow-[0_0_20px_rgba(99,102,241,0.3)]`,children:(0,Q.jsx)(he,{className:`text-white text-xl`})}),(0,Q.jsxs)(`div`,{children:[(0,Q.jsxs)(`h3`,{className:`text-2xl font-bold text-white tracking-tight`,children:[`Sahiru Sandeepa`,(0,Q.jsx)(`span`,{className:`text-indigo-400`})]}),(0,Q.jsx)(`p`,{className:`text-xs text-slate-400 font-mono`,children:`Data Science | Software Engineering`})]})]}),(0,Q.jsx)(`p`,{className:`text-slate-400 text-sm leading-relaxed pr-4`,children:`Architecting intelligent systems and crafting visually compelling digital branding for modern networks.`}),(0,Q.jsxs)(`div`,{className:`flex gap-4 pt-2`,children:[(0,Q.jsx)(`div`,{className:`animate-floating`,style:{animationDelay:`0s`},children:(0,Q.jsx)(`a`,{href:`https://github.com/Sahiru1010`,target:`_blank`,rel:`noopener noreferrer`,className:`w-10 h-10 rounded-lg bg-slate-900/80 border-2 border-indigo-500/60 shadow-[0_0_12px_rgba(99,102,241,0.5)] flex items-center justify-center text-indigo-400 hover:text-white hover:bg-indigo-500/20 hover:border-indigo-400 hover:shadow-[0_0_25px_rgba(99,102,241,0.9)] transition-all duration-300`,children:(0,Q.jsx)(j,{size:18})})}),(0,Q.jsx)(`div`,{className:`animate-floating`,style:{animationDelay:`0.4s`},children:(0,Q.jsx)(`a`,{href:`https://www.linkedin.com/in/sahiru-sandeepa-9b1914267/`,target:`_blank`,rel:`noopener noreferrer`,className:`w-10 h-10 rounded-lg bg-slate-900/80 border-2 border-blue-500/60 shadow-[0_0_12px_rgba(59,130,246,0.5)] flex items-center justify-center text-blue-400 hover:text-white hover:bg-blue-500/20 hover:border-blue-400 hover:shadow-[0_0_25px_rgba(59,130,246,0.9)] transition-all duration-300`,children:(0,Q.jsx)(ie,{size:18})})}),(0,Q.jsx)(`div`,{className:`animate-floating`,style:{animationDelay:`0.8s`},children:(0,Q.jsx)(`a`,{href:`mailto:sahirusandeepa52@gmail.com`,target:`_blank`,rel:`noopener noreferrer`,className:`w-10 h-10 rounded-lg bg-slate-900/80 border-2 border-emerald-500/60 shadow-[0_0_12px_rgba(16,185,129,0.5)] flex items-center justify-center text-emerald-400 hover:text-white hover:bg-emerald-500/20 hover:border-emerald-400 hover:shadow-[0_0_25px_rgba(16,185,129,0.9)] transition-all duration-300`,children:(0,Q.jsx)(fe,{size:18})})})]})]})}),(0,Q.jsx)(`div`,{className:`col-span-1 flex md:justify-center`,children:(0,Q.jsx)(`div`,{className:`w-fit`,children:(0,Q.jsxs)(Ll,{delay:200,className:`space-y-6`,children:[(0,Q.jsx)(`h4`,{className:`text-lg font-bold text-white tracking-wide`,children:`Quick Links`}),(0,Q.jsx)(`ul`,{className:`space-y-3`,children:[`About`,`Education`,`Portfolio`,`Services`,`Contact`].map(e=>(0,Q.jsx)(`li`,{children:(0,Q.jsxs)(`a`,{href:`#${e.toLowerCase()}`,className:`text-slate-400 text-sm hover:text-indigo-400 transition-colors flex items-center gap-2 group w-fit`,children:[(0,Q.jsx)(ge,{size:10,className:`opacity-0 -translate-x-3 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 text-indigo-500`}),(0,Q.jsx)(`span`,{className:`group-hover:translate-x-1 transition-transform duration-300`,children:e})]})},e))})]})})}),(0,Q.jsx)(`div`,{className:`col-span-1 flex md:justify-end`,children:(0,Q.jsx)(`div`,{className:`w-fit`,children:(0,Q.jsxs)(Ll,{delay:300,className:`space-y-6`,children:[(0,Q.jsx)(`h4`,{className:`text-lg font-bold text-white tracking-wide`,children:`Get In Touch`}),(0,Q.jsxs)(`ul`,{className:`space-y-5`,children:[(0,Q.jsx)(`li`,{children:(0,Q.jsxs)(`a`,{href:`mailto:sahirusandeepa52@gmail.com`,target:`_blank`,rel:`noopener noreferrer`,className:`flex items-center gap-4 text-slate-400 hover:text-white transition-colors group`,children:[(0,Q.jsx)(`div`,{className:`w-10 h-10 shrink-0 rounded-lg bg-slate-800/50 border border-white/5 flex items-center justify-center group-hover:bg-indigo-500/20 group-hover:border-indigo-500/30 transition-all duration-300`,children:(0,Q.jsx)(fe,{className:`text-indigo-400 group-hover:scale-110 transition-transform`})}),(0,Q.jsx)(`span`,{className:`text-sm truncate`,children:`sahirusandeepa52@gmail.com`})]})}),(0,Q.jsx)(`li`,{children:(0,Q.jsxs)(`a`,{href:`tel:+94 70 213 2649`,className:`flex items-center gap-4 text-slate-400 hover:text-white transition-colors group`,children:[(0,Q.jsx)(`div`,{className:`w-10 h-10 shrink-0 rounded-lg bg-slate-800/50 border border-white/5 flex items-center justify-center group-hover:bg-purple-500/20 group-hover:border-purple-500/30 transition-all duration-300`,children:(0,Q.jsx)(P,{className:`text-purple-400 group-hover:scale-110 transition-transform`})}),(0,Q.jsx)(`span`,{className:`text-sm`,children:`+94 70 213 2649`})]})}),(0,Q.jsx)(`li`,{children:(0,Q.jsxs)(`div`,{className:`flex items-center gap-4 text-slate-400 group cursor-default`,children:[(0,Q.jsx)(`div`,{className:`w-10 h-10 shrink-0 rounded-lg bg-slate-800/50 border border-white/5 flex items-center justify-center group-hover:bg-pink-500/20 group-hover:border-pink-500/30 transition-all duration-300`,children:(0,Q.jsx)(ue,{className:`text-pink-400 group-hover:animate-bounce`})}),(0,Q.jsx)(`span`,{className:`text-sm`,children:`Colombo, Sri Lanka`})]})})]})]})})})]}),(0,Q.jsxs)(`div`,{className:`border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4`,children:[(0,Q.jsx)(`p`,{className:`text-slate-500 text-sm`,children:`© 2026 Sahiru Sandeepa. All rights reserved.`}),(0,Q.jsxs)(`div`,{className:`flex gap-6 text-sm font-medium text-slate-500`,children:[(0,Q.jsx)(`a`,{href:`#`,className:`hover:text-indigo-400 transition-colors`,children:`Privacy Policy`}),(0,Q.jsx)(`a`,{href:`#`,className:`hover:text-indigo-400 transition-colors`,children:`Terms of Service`}),(0,Q.jsx)(`a`,{href:`#`,className:`hover:text-indigo-400 transition-colors`,children:`Sitemap`})]})]})]})]}),(0,Q.jsxs)(`div`,{className:`fixed bottom-6 right-6 z-50 flex flex-col items-end`,children:[(0,Q.jsxs)(`div`,{className:`mb-4 w-[350px] glass bg-slate-900/90 rounded-2xl border border-indigo-500/30 shadow-2xl overflow-hidden transition-all duration-500 origin-bottom-right ${n?`opacity-100 scale-100 pointer-events-auto`:`opacity-0 scale-75 pointer-events-none absolute`}`,children:[(0,Q.jsxs)(`div`,{className:`bg-indigo-600/20 border-b border-indigo-500/20 p-4 flex justify-between items-center backdrop-blur-md`,children:[(0,Q.jsxs)(`div`,{className:`flex items-center gap-3`,children:[(0,Q.jsxs)(`div`,{className:`relative`,children:[(0,Q.jsx)(`div`,{className:`w-8 h-8 rounded-full bg-indigo-500 flex items-center justify-center`,children:(0,Q.jsx)(N,{size:16,className:`text-white`})}),(0,Q.jsx)(`span`,{className:`absolute bottom-0 right-0 w-2.5 h-2.5 bg-green-500 border-2 border-slate-900 rounded-full`})]}),(0,Q.jsx)(`div`,{children:(0,Q.jsx)(`h4`,{className:`text-sm font-bold text-white leading-tight`,children:`Sahiru AI`})})]}),(0,Q.jsx)(`button`,{onClick:()=>r(!1),className:`text-slate-400 hover:text-white transition-colors`,children:(0,Q.jsx)(se,{size:20})})]}),(0,Q.jsxs)(`div`,{className:`h-72 p-4 overflow-y-auto flex flex-col gap-4`,children:[i.map((e,t)=>(0,Q.jsx)(`div`,{className:`flex ${e.sender===`user`?`justify-end`:`justify-start`}`,children:(0,Q.jsx)(`div`,{className:`max-w-[80%] rounded-2xl p-3 text-sm shadow-md ${e.sender===`user`?`bg-indigo-600 text-white rounded-br-sm`:`glass border border-white/5 text-slate-200 rounded-bl-sm`}`,children:e.text})},t)),c&&(0,Q.jsx)(`div`,{className:`flex justify-start`,children:(0,Q.jsxs)(`div`,{className:`glass border border-white/5 rounded-2xl rounded-bl-sm p-4 shadow-md flex gap-1 items-center`,children:[(0,Q.jsx)(`div`,{className:`w-1.5 h-1.5 bg-slate-400 rounded-full typing-dot`}),(0,Q.jsx)(`div`,{className:`w-1.5 h-1.5 bg-slate-400 rounded-full typing-dot`}),(0,Q.jsx)(`div`,{className:`w-1.5 h-1.5 bg-slate-400 rounded-full typing-dot`})]})}),(0,Q.jsx)(`div`,{ref:u})]}),(0,Q.jsxs)(`form`,{onSubmit:e=>{e.preventDefault();let t=o.trim();if(!t)return;a(e=>[...e,{sender:`user`,text:t}]),s(``),l(!0);let n=b(t);setTimeout(()=>{l(!1),a(e=>[...e,{sender:`ai`,text:n}])},1500)},className:`p-3 border-t border-white/10 bg-slate-950/50 flex gap-2`,children:[(0,Q.jsx)(`input`,{type:`text`,value:o,onChange:e=>s(e.target.value),placeholder:`Ask about my projects...`,className:`flex-1 bg-slate-900 border border-white/10 rounded-xl px-4 py-2 text-sm text-white placeholder:text-slate-500 outline-none`}),(0,Q.jsx)(`button`,{type:`submit`,disabled:!o.trim()||c,className:`bg-indigo-600 text-white p-2 rounded-xl flex items-center justify-center w-10`,children:(0,Q.jsx)(le,{size:16})})]})]}),(0,Q.jsx)(`button`,{onClick:()=>r(!n),className:`w-14 h-14 rounded-full flex items-center justify-center text-white shadow-lg shadow-indigo-900/50 transition-all duration-300 border border-indigo-400/30 ${n?`bg-slate-800 scale-90 rotate-90`:`bg-indigo-600 hover:bg-indigo-500 hover:scale-110`}`,children:n?(0,Q.jsx)(se,{size:24,className:`-rotate-90`}):(0,Q.jsx)(me,{size:24})})]})]})]})}(0,v.createRoot)(document.getElementById(`root`)).render((0,Q.jsx)(_.StrictMode,{children:(0,Q.jsx)(Rl,{})}));